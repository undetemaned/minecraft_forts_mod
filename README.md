# Jade's Quilt Kotlin Template Mod

This template is based on QuiltMC's [Official Quilt Template](https://github.com/QuiltMC/quilt-template-mod), but using Kotlin where possible instead of Java!
If you want to use this, you can, but it's meant for my mods, so I have less boilerplate to write.
...
Mods created with this template are not automatically licensed under the CC0, and are not required to give any kind of credit back to QuiltMC or jadelily18 for this template.
